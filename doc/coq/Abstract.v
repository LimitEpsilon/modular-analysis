...
Proof.
  ...
  - intros. unfold ctx_bound_expr in *. destruct H as [memi expri].
    ...
    + unfold ctx_bound_st in *. unfold update_m. intro addr.
      ...
      remember (mem (t :: (dy_level C_lam))) as ovl. destruct ovl.
      * intros. specialize (memarg (t :: (dy_level C_lam))).
      ...
      * intros. simpl in INvl. destruct INvl as [eq_arg | [eq_val | in_ovl]].
        ...
        { rewrite eq_val in *. assert (In (Val v pf0 C_v) (mem (t :: (dy_level C_lam)))).
          rewrite <- Heqovl. simpl; eauto. eapply memarg.
          apply H. eauto. }
        { assert (In (Val v pf0 C_v) (mem (t :: (dy_level C_lam)))).
          rewrite <- Heqovl. simpl; eauto. eapply memarg.
          apply H. eauto. } 
      * apply memarg.
  ...
  - intros C st x e m C_x mem t v pf 
    ...
    + unfold ctx_bound_st in *. unfold update_m. intro addr.
      ...
      remember (mem (t :: (dy_level C))) as ovl. destruct ovl.
      * intros. specialize (memm (t :: (dy_level C))).
      ...
      * intros. simpl in INvl. destruct INvl as [eq_e | [eq_val | in_ovl]].
        ...
        { rewrite eq_val in *. assert (In (Val v0 pf0 C_v) (mem (t :: (dy_level C)))).
          rewrite <- Heqovl. simpl; eauto. eapply memm.
          apply H. eauto. }
        { assert (In (Val v0 pf0 C_v) (mem (t :: (dy_level C)))).
          rewrite <- Heqovl. simpl; eauto. eapply memm.
          apply H. eauto. }
      * apply memm.
