...
\begin{lemma}[Injection Preserves $\semarrow$]
  ...
  \[\config_2\semarrow\rightst_2\Rightarrow\inject{s_1}{\config_2}\semarrow\inject{s_1}{\rightst_2}\]
\end{lemma}
\begin{proof}[Sketch]
...
\begin{lemma}[Injection Preserves $\A\semarrow$]
  ...
  \[\A\config_2\A\semarrow\A\rightst_2\Rightarrow\inject{\A{s}_1}{\A\config_2}\A\semarrow\inject{\A{s}_1}{\A\rightst_2}\]
\end{lemma}
\begin{proof}[Sketch]
