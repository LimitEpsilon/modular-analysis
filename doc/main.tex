...
Now we define injection between $s_1=(\ctx_1,\mem_1,t_1)\in\State_1$ and $o_2=(V_2,\mem_2,t_2)\in\Outcome_2$:
\[
  \begin{array}{cc}
...
First, $\inject{s_1}{o_2}\in\Outcome_+$ with respect to the ordering $\le_+$.
