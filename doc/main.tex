...
Using this formalism, we proved that Lemma \ref{lem:injpresaval} holds with respect to \emph{another} injection operator.
Moreover, we proved that finitizing the abstract timestamp is again sufficient to guarantee termination of analysis (Theorem \ref{thm:absfinite}).
...
%                                                                                           & $((x,\prexists[blue]{t}\cons C_{\lambda,2},\mem_{a,2}[t\mapsto v_a])$              & \multicolumn{1}{l}{\hspace{\equivadjust}$\equivalent[red](C_\lambda,\mem_{a,\lambda})$}
%  \end{tabular}
