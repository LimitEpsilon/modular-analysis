...
\[\inject{\A{\ctx}_1}{\A\mem_2}\triangleq\lambda\A{t}.\{\inject{\A{\ctx}_1}{\A{v}_2}|\A{v}_2\in\A\mem_2(\A{t})\}\text{ when }\inject{\A\ctx_1}{\A{v}_2}\text{ is the same as concrete injection}\]
...
\begin{theorem}[Abstract Advance]\label{thm:absadvance}
