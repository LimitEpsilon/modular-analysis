...
Here is a general outline that utilize abstract equivalence and abstract linking to overapproximate any initial state $\Abs{S}$.
...
Using this formalism, we ported all proofs from the simple language with minimal effort.
